...
public struct  HistoryNoUsePointModel: BaseModel {
    public var identifier: String = "NoUsingPointCell"
...
extension  HistoryNoUsePointModel: ImmutableMappable {
